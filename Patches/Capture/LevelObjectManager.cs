...
namespace ShowPerfExtensions
{
  public partial class Plugin : IAssemblyPlugin
  {
    ...
    {
      if (!Capture.LevelObjectsDrawing.IsActive) return true;
      Window.EnsureCategory(Capture.LevelObjectsDrawing.Category);
      ...
      foreach (LevelObject obj in objectList)
      {
        ...
        if (obj.Prefab != null)
        {
          Window.AddTicks(new UpdateTicks(ticks, Capture.LevelObjectsDrawing.Category, obj.Prefab.Identifier));
        }
        else
        {
          Window.AddTicks(new UpdateTicks(ticks, Capture.LevelObjectsDrawing.Category, $"{obj}"));
        }
