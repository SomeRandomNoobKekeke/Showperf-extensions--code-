...
namespace ShowPerfExtensions
{
  public partial class Mod : IAssemblyPlugin
  {
    ...
    {
      if (!Capture.LevelMisc.IsActive) return true;
      Window.EnsureCategory(Capture.LevelMisc.Category);
      ...
      spriteBatch.End();
      Window.AddTicks(new UpdateTicks(sw.ElapsedTicks, Capture.LevelMisc.Category, "BackgroundTopSprite"));
      ...
      Window.AddTicks(new UpdateTicks(sw.ElapsedTicks, Capture.LevelMisc.Category, "BackgroundCreatures"));
      ...
      spriteBatch.End();
      Window.AddTicks(new UpdateTicks(sw.ElapsedTicks, Capture.LevelMisc.Category, "WaterParticles"));

      sw.Restart();
      _.RenderWalls(GameMain.Instance.GraphicsDevice, cam);
      Window.AddTicks(new UpdateTicks(sw.ElapsedTicks, Capture.LevelMisc.Category, "RenderWalls"));
